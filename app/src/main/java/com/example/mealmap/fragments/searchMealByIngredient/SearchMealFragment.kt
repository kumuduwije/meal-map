package com.example.mealmap.fragments.searchMealByIngredient
...
import com.example.mealmap.databinding.FragmentSearchMealBinding
...
//        Log.d("ScrollList::", convertToJson(allMealMap))
    ...
    private fun changeDataFormat(jsonArr: JSONArray): Map<String, String> {
        ...
        // if(mealObject.getString().startsWith(pattern))
        ...
        //Log.d("Mealmap:::", mealMap.toString())
    ...
    private suspend fun getResponseFromWeb(text: String): JSONArray = withContext(Dispatchers.IO) {
        ...
        //getMealIdFromWebResult(stb)
        //print("Connection::$stb")
