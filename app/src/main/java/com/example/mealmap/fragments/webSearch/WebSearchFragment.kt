package com.example.mealmap.fragments.webSearch
...
import com.example.mealmap.databinding.FragmentWebSearchBinding
...
// format the String according to given format.
@Throws(JSONException::class)
private fun parseJson(json: String): String {
    val meals = StringBuilder()
    val jsonObject = JSONObject(json)
    val mealsArray = jsonObject.getJSONArray("meals")
    //Toast.makeText(context, "${mealsArray.length()} meals received from the Web Service.", Toast.LENGTH_SHORT).show()
