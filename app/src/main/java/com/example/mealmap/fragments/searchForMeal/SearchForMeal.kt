...
import com.example.mealmap.MainViewModel
import com.example.mealmap.data.Meal
import com.example.mealmap.data.MealDatabase
import com.example.mealmap.data.MealViewModel
import com.example.mealmap.databinding.FragmentSearchForMealBinding
...
//                if (mealByIngredient.isNotEmpty()) {
//                        Log.d("All mealByIngredient", mealByIngredient.size.toString())
//                    }

                lifecycleScope.launch {
                    withContext(Dispatchers.Main) {
                        // Do something
                        //Log.d("mealsByIngredient size::", mealByIngredient.size.toString())
                        //Log.d("mealsByIngredient", mealByIngredient[0].ingredients[0].toString())
